...
footer = dbc.Container(
    dbc.Row(
        dbc.Col(
            html.P(
                [
                    html.Span('Ross Fisher', className='mr-2'), 
                    html.A(html.I(className='fas fa-envelope-square mr-1'), href='mailto:rcfisher@gmail.com'), 
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/ross-fisher/<repo>'), 
                    html.A(html.I(className='fab fa-linkedin mr-1'), href='https://www.linkedin.com/in/ross-fisher-65929a193/'), 
